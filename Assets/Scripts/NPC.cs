...
public class NPC : Character, IInteractable
{
    ...
    public void Interact(GameObject interactionSource) { if (interactionSource == GameManager.Instance.playerObject) DialogManager.Instance.StartDialog(dialogScriptable, GameManager.Instance.playerObject.GetComponent<Character>()); }
